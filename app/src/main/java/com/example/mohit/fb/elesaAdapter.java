...
public class elesaAdapter extends RecyclerView.Adapter<elesaAdapter.ImageViewHolder> {


        private Context mcontext;
        private List<Upload> mUploads;

        public elesaAdapter(Context context,List<Upload> ARTCIRCLE){
            mcontext = context;
            mUploads = ARTCIRCLE;
        ...
        @Override
        public com.example.mohit.fb.elesaAdapter.ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(mcontext).inflate(R.layout.artdisp,parent,false);
            return new com.example.mohit.fb.elesaAdapter.ImageViewHolder(v);
        }

        @Override
        public void onBindViewHolder(com.example.mohit.fb.elesaAdapter.ImageViewHolder holder, int position) {

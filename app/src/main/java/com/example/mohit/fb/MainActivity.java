...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(MainActivity.this,"WELCOME TO MESA UPDATION",Toast.LENGTH_LONG).show();


            mStorageRef = FirebaseStorage.getInstance().getReference("MESA");
    ...
    private void uploadFile()
    {
        ...
        {
            Toast.makeText(this,"Content to be inserted",Toast.LENGTH_SHORT).show();
        }
        else if(mTime == null)
        {
            Toast.makeText(this,"Time need to be inserted",Toast.LENGTH_SHORT).show();
        }
        else if(mDate == null)
        {
            Toast.makeText(this,"Date need to be inserted",Toast.LENGTH_SHORT).show();
        }
        else if(mImageUri == null)
        {
            Toast.makeText(this,"Image need to be selected",Toast.LENGTH_SHORT).show();
        }
        else
        {

...
public class saitAdapter extends RecyclerView.Adapter<saitAdapter.ImageViewHolder> {
    ...
    public saitAdapter(Context context,List<Upload> SAIT){
        mcontext = context;
        mUploads = SAIT;
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mcontext).inflate(R.layout.saitdisp,parent,false);

...
public class mesaAdapter extends RecyclerView.Adapter<mesaAdapter.ImageViewHolder> {
    ...
    public mesaAdapter(Context context,List<Upload> MESA){
        mcontext = context;
        mUploads = MESA;
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mcontext).inflate(R.layout.mesadisp,parent,false);

...
public class eesalogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(eesalogin.this,"WELCOME TO EESA UPDATION",Toast.LENGTH_LONG).show();



        mStorageRef = FirebaseStorage.getInstance().getReference("EESA");
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("EESA");
        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(eesalogin.this, "Upload in Progress", Toast.LENGTH_SHORT).show();
                } else {
                    uploadFile();
                }
            ...
            mUploadTask = fileRefernce.putFile(mImageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(eesalogin.this,"Uploaded Successfully",Toast.LENGTH_LONG).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(eesalogin.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                        }
                    })

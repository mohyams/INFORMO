...
public class paceAdapter extends RecyclerView.Adapter<paceAdapter.ImageViewHolder>{


    private Context mcontext;
    private List<Upload> mUploads;

    public paceAdapter(Context context,List<Upload> PACE){
        mcontext = context;
        mUploads = PACE;
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mcontext).inflate(R.layout.pacedisp,parent,false);

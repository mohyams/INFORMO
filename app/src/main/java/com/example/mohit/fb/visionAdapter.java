...
public class visionAdapter extends RecyclerView.Adapter<visionAdapter.ImageViewHolder>{


    private Context mcontext;
    private List<Upload> mUploads;

    public visionAdapter(Context context,List<Upload> VISION){
        mcontext = context;
        mUploads = VISION;
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mcontext).inflate(R.layout.visiondisp,parent,false);

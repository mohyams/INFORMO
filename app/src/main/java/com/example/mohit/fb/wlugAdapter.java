...
public class wlugAdapter extends RecyclerView.Adapter<wlugAdapter.ImageViewHolder> {
    ...
    public wlugAdapter(Context context,List<Upload> WLUG){
        mcontext = context;
        mUploads = WLUG;
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mcontext).inflate(R.layout.wlugdisp,parent,false);

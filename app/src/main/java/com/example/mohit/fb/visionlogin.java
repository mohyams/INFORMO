...
public class visionlogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(visionlogin.this,"WELCOME TO VISION UPDATION",Toast.LENGTH_LONG).show();




        mStorageRef = FirebaseStorage.getInstance().getReference("VISION");
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("VISION");
        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(visionlogin.this, "Upload in Progress", Toast.LENGTH_SHORT).show();
                } else {
                    uploadFile();
                }
            ...
            mUploadTask = fileRefernce.putFile(mImageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(visionlogin.this,"Uploaded Successfully",Toast.LENGTH_LONG).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(visionlogin.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                        }
                    })

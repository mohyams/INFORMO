...
public class rotaractAdapter extends RecyclerView.Adapter<rotaractAdapter.ImageViewHolder> {
    ...
    public rotaractAdapter(Context context,List<Upload> ROTARACT){
        mcontext = context;
        mUploads = ROTARACT;
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mcontext).inflate(R.layout.rotaractdisp,parent,false);
